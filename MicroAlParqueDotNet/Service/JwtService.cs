...
namespace MicroAlParque.Service
{
    public class JwtService
    {
        ...
        public LoginViewModel GenerateToken(Usuario usuarioLogIn)
        {
            // return null if user not found
            if (usuarioLogIn == null) return null;
            var usuarioResponse = new LoginViewModel() { 
                Nombres = usuarioLogIn.Nombres,
                PrimerApellido = usuarioLogIn.PrimerApellido,
                SegundoApellido = usuarioLogIn.SegundoApellido,
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                {
                    new Claim(ClaimTypes.Name, usuarioLogIn.NombreUsuario.ToString())
                }),
