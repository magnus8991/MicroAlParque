    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Propietarios", x => x.Identificacion);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sede = table.Column<string>(maxLength: 20, nullable: true),
                    Telefono = table.Column<int>(nullable: false),
                    IdPropietario = table.Column<string>(maxLength: 11, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restaurantes", x => x.NIT);
                    table.ForeignKey(
                        name: "FK_Restaurantes_Propietarios_IdPropietario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Manipuladores_Restaurantes_RestauranteId",
                        column: x => x.RestauranteId,
                        principalTable: "Restaurantes",
                        principalColumn: "NIT",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Manipuladores_RestauranteId",
                table: "Manipuladores",
                column: "RestauranteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurantes_IdPropietario",
                table: "Restaurantes",
